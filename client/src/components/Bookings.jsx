...
export default function Bookings({ extendedHeader, setExtendedHeader }) {
  const [hostBookings, setHostBookings] = useState([]);
  const [userBookings, setUserBookings] = useState([]);

  useEffect(() => {
    axios.get('/bookings-host').then(({ data }) => {
      setHostBookings(data);
    });
  }, []);

  useEffect(() => {
    axios.get('/bookings-user').then(({ data }) => {
  ...
  return (
    <div onMouseOver={() => setExtendedHeader(false)}>
      ...
      <div>
        <h2 className='text-2xl mt-4'>Bookings - host</h2>
              ...
              >
                ...
                <div className='pl-6 flex flex-col items-start overflow-hidden mt-2 '>
                  ...
                  <p className='hidden md:flex mt-3 pl-4 text-md text-left max-h-48  font-medium '>
                    ...
                    <span className='pl-1'>{booking.place.address}</span>
                  </p>
                  <p className=' hidden md:flex mt-2 pl-4 text-md text-left max-h-48  font-medium'>
                    ...
                    <span className='pl-1'>Total price: ${booking.price} </span>
                  </p>
                  <p className='mt-2 pl-4 text-md text-left max-h-48 hidden md:flex font-medium'>
                    ...
                    <span className='pl-1'>
                      Check in: {booking.startDate.slice(0, 10)}
                    </span>
                  </p>
                  <p className='mt-2 pl-4 text-md text-left max-h-48 hidden md:flex font-medium'>
                    <svg
                    ...
                    <span className='pl-1'>
                      Check out: {booking.endDate.slice(0, 10)}
                    </span>
                  </p>
                </div>
              </div>
        ...
        <h2 className='text-2xl mt-4'>Bookings - guest</h2>
        <div className='flex flex-col gap-5 mt-5 items-center'>
